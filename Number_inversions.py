'''Rahul is facing a unique problem, which he doesn't know how to solve. The problem asks him to build the smallest possible number by applying inversion on any digit of 
the number any number of times.
...
l=[min(int(i),9-int(i)) for i in input()]
if(l[0]==0): l[0]=9
print(*l,sep="")
